        ...
        try:
            ...
            if npk > 1 and not windowed:
                warns.append(
                    ...
                    f"slit-width number) are contaminated by the neighbour. Window "
            ...
            # contamination check: a clean single edge has a unimodal LSF. More than
            # one bump means a neighbouring peak/shoulder sits inside the region.
            ...
            metrics.object = (
                ...
                f"same edge; a much lower HMR value means its edge is contaminated."
                + slit_line
